...
> a commented sample configuration file will be more developer-friendly.
> This prose and lists are nice,
> but they do not really correspond well to the configuration file generated by the node.
...
- **tcp_keep_alive**
  ...
  Keep-alive will be disabled if this configuration is not set (default behavior).
...
[processing]: ../advanced/consensus/specification.md#message-processing
