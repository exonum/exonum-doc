...
непотраченными выходами транзакции для пополнения баланса ([UTXO пополнения баланса](https://exonum.com/doc/advanced/bitcoin-anchoring/#funding-utxo)).
...
Каждый валидатор обновляет свою LECT по [специальному расписанию](https://exonum.com/doc/advanced/bitcoin-anchoring/#lect-updating-interval).
