...
неотказуемости приложений Exonum. Этот сервис периодически публикует хеш
...
- Выходы транзакции содержат выход данных и выход остатка баланса. Сначала идет
  выход остатка баланса, а следом - выход данных.
...
обнаружена. Новый блок для анкоринга - это крайний блок блокчейна Exonum,
который
