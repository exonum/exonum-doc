...
[обработку транзакций](#_2),
[структуру сети](#_4),
[алгоритм консенсуса](#_7),
[организацию хранения данных](#_9),
[сервисы](#_12),
и [криптографию, используемую в Exonum](#_16).
...
[алгоритму консенсуса](#_7). Алгоритм также гарантирует, что будут
...
[сервисами](#_12). В частности, сервисы определяют правила
...
- **Валидаторы** обеспечивают жизнеспособность сети. Только валидаторы могут
  ...
  [алгоритм византийского консенсуса](#_7).
...
- **Локальное состояние.** Сервисы Exonum могут определять локальное состояние,
  ...
  [сервис анкоринга](#_15) использует локальное состояние
